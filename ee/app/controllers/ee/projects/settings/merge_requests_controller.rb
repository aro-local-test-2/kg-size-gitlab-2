    ...
    module Settings
      module MergeRequestsController
        ...
        def project_setting_attributes
          ...
          attributes << :security_policy_pipeline_must_succeed if allow_security_policy_pipeline_check?
          attributes << :reviewer_assignment_strategy if allow_reviewer_auto_assignment?
        ...
        def project_params_ee
          ...
          attrs << %i[merge_train_enforcement] if allow_merge_trains_params?
          attrs << %i[max_pipelines_per_merge_train] if allow_merge_trains_params?
        ...
        def allow_security_policy_pipeline_check?
          ::Feature.enabled?(:security_policy_pipeline_check, project) &&
            ::Security::PolicyAvailability.available?(project, :security_orchestration_policies)
        end

        def allow_reviewer_auto_assignment?
          project.reviewer_auto_assignment_available?
        end
      end
    end
  end
