...
RSpec.describe Namespaces::SyncNamespaceNameWorker, feature_category: :plan_provisioning do
  ...
  describe '#perform' do
    ...
    context 'when the sync fails' do
      it 'raises a RequestError' do
        response = { success: false, errors: 'foo' }
        ...
        expect { sync }.to raise_error(
          ...
          "Namespace name sync failed! Namespace id: #{namespace_id}, #{response}"
        )
      end
    end
