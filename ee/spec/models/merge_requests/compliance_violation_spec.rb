...
RSpec.describe MergeRequests::ComplianceViolation, feature_category: :compliance_management do
  ...
  describe '#by_group' do
    ...
    let_it_be(:subgroup_project) { create(:project, :small_repo, group: subgroup) }
