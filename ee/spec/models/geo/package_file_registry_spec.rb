...
RSpec.describe Geo::PackageFileRegistry, :geo, feature_category: :geo_replication do
  ...
  describe '.find_registry_differences' do
    ...
    subject(:registry_class) { described_class }
    ...
    context 'with selective sync disabled' do
      ...
      it 'finds unused and untracked items' do
        ...
        untracked, unused = registry_class.find_registry_differences(range)
