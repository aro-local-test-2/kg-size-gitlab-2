...
describe('DevopsAdoptionOverviewTable', () => {
  ...
  describe('when the parent has not loaded any data yet', () => {
    it('renders no rows and does not throw', () => {
      expect(() => createComponent({ props: { data: {} } })).not.toThrow();
      expect(wrapper.findAllByTestId(TABLE_TEST_IDS_NAMESPACE)).toHaveLength(0);
    });
  });
  ...
  describe('when delete button is clicked', () => {
    ...
    it.each(['track-modal-open-state', 'enabled-namespaces-removed'])(
