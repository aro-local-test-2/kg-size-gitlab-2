  ...
  module API
    module API
      ...
      prepended do
        ...
        mount ::API::AiSuggestedReviewers
        ...
        mount ::API::Ci::TestBalancing
        mount ::API::Clusters::AgentUrlConfigurations
        mount ::API::SecretsManagement::AccessTokens
        ...
        mount ::API::WorkItems::FeatureFlags
        ...
        mount ::API::Ai::DuoWorkflows::AgentWorkflows
        mount ::API::Ai::DuoWorkflows::CodeReview
        mount ::API::Ai::DuoWorkflows::Tools::RiskClassification::Results
        mount ::API::Ai::DuoWorkflows::AuditEvents
        mount ::API::Ai::ExternalAgents::AuditEvents
        mount ::API::Ai::ExternalAgents::Identities
        mount ::API::Ai::ExternalAgents::Sessions
        mount ::API::Ai::ThirdPartyAgents
        mount ::EE::API::Search::SemanticCodeSearch
        mount ::API::CodeSuggestions
        mount ::API::Authn::TokenExchange
        mount ::API::Chat
        mount ::API::DuoCodeReview
        mount ::API::SecurityScans
        mount ::API::ComplianceExternalControls
        mount ::API::Govern::Policies
        mount ::API::Security::DependencyFirewall::Enablement
        mount ::API::Security::DependencyFirewall::Evaluations
        ...
        mount ::API::VirtualRegistries::Packages::Npm::Cache::Remote::Entries
        mount ::API::VirtualRegistries::Packages::Npm::Registries
        mount ::API::VirtualRegistries::Packages::Npm::RegistryUpstreams
        mount ::API::Orbit::Data
        mount ::API::Orbit::Mcp
        mount ::API::Cd::Rollouts
